...
function hbag_addgallery_process()
{
        ...
        switch ($_POST['bulkaction']) {
            ...
            case 'delete_audios':
                ...
                if (is_array($_POST['doaction'])) {
                    ...
                    $doaction = array_map('sanitize_text_field', $_POST['doaction']);

                    foreach ($_POST['doaction'] as $audioID) {

                        $audio = hbag_db_get_audio($audioID);


                        $audio_path = hbag_convert_urltopath($audio['audioURL']);
    ...
    if (isset($_POST['updateaudio'])) {
        $audios = isset($_POST['aid']) ? array_map('esc_attr', $_POST['aid']) : false;

        $titles = isset($_POST['title']) ? array_map('esc_attr', $_POST['title']) : array();
        
        $artists = isset($_POST['artist']) ? array_map('esc_attr', $_POST['artist']) : array();

        $orders = isset($_POST['orders']) ? array_map('esc_attr', $_POST['orders']) : array();
            ...
            foreach ($audios as $aid) {
                ...
                if (!empty($audio)) {
                    if ($titles != 0) {
                        ...
                        hbag_db_update_audio($aid, sanitize_text_field($titles[$aid]));
                    }

                    if ($artists != 0) {

                        hbag_db_update_artist($aid, sanitize_text_field($artists[$aid]));
                    }

                    if ($orders != 0) {

                        hbag_db_update_order($aid, sanitize_text_field($orders[$aid]));
                    }
                }
            }
        }
...
?>
    ...
    <table>
        ...
        <tr>
            ...
            <td><input type="text" size="80" name="gallery_review_author_name" value="<?php echo $gallery_author; ?>" /></td>
...
function display_gallery_review_audiolist_meta_box($gallery_review)
{
    ...
    $wp_list_table = new hbag_Audio_List_Table('hbag-manage-audios');



    $audioList = hbag_db_get_AudioGallery($gallery_review->ID);
    ...
    $hidden_columns  = get_hidden_columns('hbag-manage-audios');
                        ...
                        ?>
                                ...
                                ?>
                                    ...
                                    <td <?php echo $attributes ?>>
                                        <div class="img-relative">
                                            <form method="post" action="<?php echo HBAG_URLPATH . 'lib/upload_picture.php' ?>" enctype="multipart/form-data" id="picUploadForm<?= $aid; ?>" target="uploadTarget">
                                            ...
                                            <a class="editLink" onclick="clickeditem(this)" id=<?= $aid; ?> href="javascript:void(0);"><img class="edit-icon" src="<?php echo HBAG_URLPATH . 'images/edit.svg' ?>" />
                                                <!-- Profile image -->
                                                <img src="<?php echo esc_attr($audio['picture']); ?>" class="thumbnail" id="imagePreview<?= $aid; ?>"></a>
                                        </div>
                                    </td>
                                <?php
                                ...
                                case 'artist':
                                    ...
                                    <td <?php echo $attributes ?>>
                                        ...
                                        <input name="artist[<?php echo $aid ?>]" type="text" style="width:95%; margin-bottom: 2px;" value="<?php echo stripslashes($audio['artist']) ?>" />
                                ...
                                case 'orders':
                                    ...
                                    if ($audio['orders'] == 0) { ?>
                                        ...
                                        <td <?php echo $attributes ?>>
                                            ...
                                            <input name="orders[<?php echo $aid ?>]" type="text" style="width:40%; margin-bottom: 2px;" value="" />
                                    ...
                                    <?php } else { ?>
                                        ...
                                        <td <?php echo $attributes ?>>
                                            ...
                                            <input name="orders[<?php echo $aid ?>]" type="text" style="width:40%; margin-bottom: 2px;" value="<?php echo stripslashes($audio['orders']) ?>" />
...
function display_gallery_review_upload_meta_box($gallery_review)
{
    ...
    $action_url = sanitize_option('siteurl', $action_url);

    $upload_directory = HBAG_UPLOAD_DIR . '/' . get_the_title($gallery_review->ID);
    ...
    <form name="uploadaudio" id="uploadaudio_form" method="POST" enctype="multipart/form-data" action="<?php echo $action_url; ?>" accept-charset="utf-8">
        ...
        <div class="plupload-upload-uic hide-if-no-js plupload-upload-uic-multiple" id="<?php echo $id; ?>plupload-upload-ui">
            ...
            <p style="color:#ff0000">
                <?php esc_attr_e('Upload audio files in this folder:')?> <strong><?php esc_attr_e('"'.HBAG_UPLOAD_DIR.'\\'.get_the_title().'"')?></strong> <?php esc_attr_e('and then click on the')?> <strong><?php esc_attr_e('"Scan Files"')?></strong> <?php esc_attr_e('button to add those Audio files into this Album.')?>
            </p>
...
function hbag_setting_config_page()
{
...
?>
    ...
    <div id="hb-ag-setting" class="wrap" style="width:900px;">
        ...
        <div class="" style="margin-top: 40px;">
            ...
            <div style="margin-left: 20px;">
                ...
                <form method="post" action="admin-post.php" enctype="multipart/form-data">
                    ...
                    <input type="hidden" name="action" value="save_hb_ag_option" />



                    <?php wp_nonce_field('hb_ag_setting'); ?>

                    <table>

                        <tr>

                            <td style="width: 200px;"><input type="checkbox" name="hbag_audio_download_enable" <?php if ($options['hbag_audio_download_enable']) echo ' checked="checked" '; ?> /> Enable Audio Download</td>
                        ...
                        <tr>
                            ...
                            <td style="width: 200px;"><input type="checkbox" name="hbag_audio_facebook_sharing" <?php if ($options['hbag_audio_facebook_sharing']) echo ' checked="checked" '; ?> /> Enable Facebook Sharing</td>
                        ...
                        <tr>
                            ...
                            <td style="width: 200px;"><input type="checkbox" name="hbag_audio_addthis_sharing" <?php if ($options['hbag_audio_addthis_sharing']) echo ' checked="checked" '; ?> /> Enable Addthis Sharing</td>
                        ...
                        <tr>
                            ...
                            <td style="width: 200px;"><input type="checkbox" name="hbag_audio_favourites" <?php if ($options['hbag_audio_favourites']) echo ' checked="checked" '; ?> /> Enable Favourites Songs</td>
            ...
            <div style="margin-left: 20px;">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td><code>[hb-audio-single-audio aid="<span style="color: #0088d0">(audio id)</span>"]</code></td>
        ...
        <div class="" style="margin-top: 40px;">
            ...
            <h3>Audio Player Skin Color</h3>

            <div style="margin-left: 20px;" id="hbag-color-picker">

            <form method="post" action="admin-post.php" enctype="multipart/form-data">

                <input type="hidden" name="action" value="update_player_theme_color" />
                <input type="text" value="<?=get_option('theme_color') ?>"name="theme_color" class="hbag-color-field"/><br>

                <input type="hidden" name="action" value="update_player_theme_color" />
                <input type="text" value="<?=get_option('theme_secondary_color') ?>"name="theme_secondary_color" class="hbag-color-field"/><br>
                <input type="submit" name="submit" value="Change Color" class="button-primary"/>
        ...
        if ($htaccess_content === false) {
            ...
            $success = hbag_WriteNewHtaccess('# Created by HB Audio Gallery Plugin');
            ...
            <div class="" style="margin-top: 40px;">
                ...
                <div style="margin-left: 20px;">
                    ...
                    <form method="post" action="admin-post.php" enctype="multipart/form-data">
                        ...
                        <textarea id="ht_content" name="ht_content" class="" style="width:450px; height: 239px; resize: none;"><?php echo $htaccess_content; ?></textarea>
...
class hbag_Audio_List_Table extends WP_List_Table
{
    ...
    function get_columns()
    {
        ...
        $columns['artist'] = __('Artist', 'hb');

        $columns['orders'] = __('Orders', 'hb');    //Define new column order

        $columns['picture'] = __('Picture', 'hb');
